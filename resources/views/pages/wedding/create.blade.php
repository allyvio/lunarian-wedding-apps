                        ...
                        <div id="theme-selection">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="theme-tropical" name="theme" class="custom-control-input" value="tropical">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="theme-rustic" name="theme" class="custom-control-input" value="rustic">
