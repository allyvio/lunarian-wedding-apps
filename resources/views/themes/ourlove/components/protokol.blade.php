  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center mb-100">
        <h1 class="title">PROTOKOL KESEHATAN</h1>
        <div class=" text-center">
          <p class="lead mt-20 size-m">
            Tanpa mengurangi rasa hormat, dikarenakan situasi yang sedang terjadi ditengah pandemi
            covid-19 ini kami memohon maaf karena acara pernikahan kami diselenggarakan sesuai peraturan
          ...
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <h4 class="h3 text-danger text-uppercase">CUCI TANGAN</h4>
                <p>
          ...
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <h4 class="h3 text-danger text-uppercase">GUNAKAN MASKER</h4>
                <p>
          ...
          <div class="col-lg-4">
            <div class="card card-lift--hover shadow border-0">
              <div class="card-body py-5">
                ...
                <h4 class="h3 text-danger text-uppercase">JAGA JARAK</h4>
                <p>
                  Jaga jarak antar tamu sekitar 2 meter sampai 3 meter
