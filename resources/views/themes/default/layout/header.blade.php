<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/themes/default/css/magnific-popup.css')}}" type="text/css">
    ...
    <!-- color scheme -->
    <link rel="stylesheet" href="{{asset('assets/themes/default/css/color.css')}}" type="text/css" id="colors">
</head>