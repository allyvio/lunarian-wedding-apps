        ...
        <div class="about-us clearfix">
            <div class="about-us-block first-block">
                <div class="top-block">
                    <div class="name">
                        ...
                        <ul class="social-links">
                            ...
                            <li><a class="tip social-button" href="#" title="Facebook"><i
                ...
                <div class="bottom-block">
                    <p>Nulla eros eros, tincidunt in tempor vitae, pellentesque non mi. Mauris eu molestie
                        lacus, eget dictum orci. Etiam semper mauris neque, in posuere lacus varius.</p>
                </div>
            </div>
