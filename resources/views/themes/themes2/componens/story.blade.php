    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2 text-center mb-30">
                <h2 class="heavy">Ketika Sara Miller Bertemu Ben Shneider<br><span>Hari itu mengubah segalanya</span>
                </h2>
            </div>
        ...
        <div class="row story-row mt-100 mb-100">
            ...
            <div class="col-sm-5 ">
                <div class="couple-story text-right">
                    <h2 class="heavy mb-10">Pertemuan pertama kita<br><span>12 September 2016</span></h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ultrices malesuada ante
                        quis pharetra. Nullam notn bibendum dolor. Ut vel turpis accumsan, efficitur dolor
                        fermentum, tincidunt metus. Etiam ut ultrices nibh. Etiam aliquam mauris non hendrerit
                        faucibus</p>
                </div>
            </div>
            <div class="col-sm-5 col-sm-offset-2">
                <div class="couple-story">
                    <h2 class="heavy mb-10">Kencan pertama kami<br><span>23 Oktober 2016</span></h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ultrices malesuada ante
                        quis pharetra. Nullam notn bibendum dolor. Ut vel turpis accumsan, efficitur dolor
                        fermentum, tincidunt metus. Etiam ut ultrices nibh. Etiam aliquam mauris non hendrerit
                        faucibus</p>
        ...
        <div class="row story-row mt-100 mb-80 ">
            ...
            <div class="col-sm-5 ">
                <div class="couple-story text-right">
                    <h2 class="heavy mb-10">Bagaimana dia melamar<br><span>27 Januari 2017</span></h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ultrices malesuada ante
                        quis pharetra. Nullam notn bibendum dolor. Ut vel turpis accumsan, efficitur dolor
                        fermentum, tincidunt metus. Etiam ut ultrices nibh. Etiam aliquam mauris non hendrerit
                        faucibus</p>
            ...
            <div class="col-sm-5 col-sm-offset-2">
                <div class="couple-story">
                    <h2 class="heavy mb-10">Sejak itu kita bersama<br><span>Untuk menyajikan</span></h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer ultrices malesuada ante
                        quis pharetra. Nullam notn bibendum dolor. Ut vel turpis accumsan, efficitur dolor
                        fermentum, tincidunt metus. Etiam ut ultrices nibh. Etiam aliquam mauris non hendrerit
                        faucibus</p>
